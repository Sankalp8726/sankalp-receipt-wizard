...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-teal-50 dark:from-blue-950 dark:to-teal-950">
      <div className="container mx-auto px-4 py-12">
        ...
        {!showForm ? (
          <Card className="max-w-lg mx-auto p-8 shadow-lg dark:border-gray-700">
            <div className="text-center space-y-6">
              ...
              <Button 
                className="bg-blue-700 hover:bg-blue-800 text-white px-8 py-6 text-lg dark:bg-blue-800 dark:hover:bg-blue-700"
